"""
clip_detector_arimav.py  —  CLIP-powered object tracking on e-puck (Webots)
                             with full benchmark instrumentation.
                             Uses ARIMA-V scheduler for distributed inference.
    ...
    if run_inference:
        ...
        if image is not None:
            with torch.no_grad():
                ...
                pooled_output = model.vision_model.post_layernorm(cls_token)
